...
<div class="orderFormLCol">
    ...
    <div class="paymentDetails">
        <form action="/secure/?sessid2=sessid20150417070810267&amp;account_id=2438&amp;screen=curly_cart_v1&amp;store_id=5&amp;product_codename=lotto_crusher&amp;redirect=http%3A%2F%2Flotto-crusher.org%2Fupgrade-a%2F%3Fitem%3D1%26suid%3D2ck7m06khvd870hh32pc25g393" class="form-horizontal" id="checkout" method="post" name="checkout">
            ...
            <div class="form-group">
                <label class="col-md-4 control-label" for="creditcards_ccv">Validation Code:</label>

                <div class="col-md-2">
                    <input class="form-control" name="creditcards_ccv" placeholder="cvv" size="4" type="text" value="">
                </div>
            </div>

            <div class="form-group">
                <label class="col-md-4 control-label" for="refunds_policy_agreed">Terms of agreement</label>

                <div class="col-md-8" style="margin-top: 6px;">
                    <input name="refunds_policy_agreed" style="margin-right: 5px;" type="checkbox"><strong>I agree to the <a target="_blank" href="/terms.php">Terms &amp; Conditions</a>, <a target="_blank" href="/privacy.php">Privacy Policy</a> and <a target="_blank" href="/refunds.php">Refunds Policy</a></strong>
                </div>
            </div>
            ...
            <div class="form-group">
                <div class="col-md-offset-4 col-md-8">
                    <div id="submitButtonContainer">
                        <a class="btn btn-danger form-control" href="/download.php?product=ALG" id="submitButton" type="button"><i class="fa fa-arrow-right"></i> Submit Order</a>
                    </div>
                </div>
            </div>
            <div class="form-group">
                <div class="col-md-offset-4 col-md-8">
                    <p><strong>You will be able to download your product in a few seconds, right after you click the "Submit Order" Button.</strong></p>
                </div>
            </div>
        </form>
    </div>
